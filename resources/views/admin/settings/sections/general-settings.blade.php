        ...
        <form action="{{ route('admin.settings.general') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{ config('settings.site_email') }}"
                        name="site_email">
                    <x-input-error :messages="$errors->get('site_email')" class="mt-2" />
                </div>
                <div class="col-md-6">
                    <div class="form-label">Site Phone</div>
                    <input type="text" class="form-control" value="{{ config('settings.site_phone') }}"
                        name="site_phone">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" value="{{ config('settings.site_currency_icon') }}"
